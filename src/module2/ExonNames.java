...
public class ExonNames {
    ...
    public static void main(String[] args) {
        ...
        String halfOfName2 = names.makeHalfOfName("Magicoraxi");
        System.out.println("names.makeHalfOfName2(\"Magicoraxi\") = " + names.makeHalfOfName("Magicoraxi"));

        String halfOfName3 = names.makeHalfOfName("Javametro");
        System.out.println("names.makeHalfOfName(\"Javametro\") = " + names.makeHalfOfName("Javametro"));
    }
}
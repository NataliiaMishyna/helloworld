...
public class MyLinkedList <T> {
    private int size = 0;
    private transient Node<T> first; // нужна для задания ссылки предыдущей ноде на следующую вновь созданную ноду.
    private transient Node<T> last; // переменная содержащая ссылку на последнюю созданную ноду.
    private transient Node<T> linkFirst; // постоянно содержит ссылку на первую ноду
    private transient Node<T> linkLast; // постоянно содержит ссылку на самую последнюю созданную ноду
